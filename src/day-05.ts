...
const guests: string[] = ["Hassan", "Sheraz", "Waqar"];

//Via for of loop

for (let guest of guests) {
  console.log(
    `Hi Ramzan here ${guest} join me on dinner on 19-June-2024 at "MoveenPick Hotel" at sharp 09:00PM o clock.`
  );
}
...
const guests2: string[] = ["Hassan", "Sheraz", "Waqar"];
