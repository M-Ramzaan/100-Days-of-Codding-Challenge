...
console.log(`"Muhammad Ali Jinnah once said,"Think 100 times before taking a decision but once a decision is taken. Stick to it as a man"".`);
...
let myFavPerson = "Muhammad Ali Jinnah";
let message = `"${myFavPerson} once said,"Think 100 times before taking a decision but once a decision is taken. Stick to it as a man"".`;
console.log(message);
...
let personName = "Muhammad \tRamzan      \nAkram";
...
let myFavNumber = 1418;
let message1 = `My favorite number is ${myFavNumber}`;
...
let favNumber = 1418;
let message_1 = `My favorite number is ${myFavNumber}`;
...
let myFriends = ["Hassan", "Sheraz", "Junaid"];
